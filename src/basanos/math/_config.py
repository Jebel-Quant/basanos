...
unaffected. The covariance-mode configs live in ``_covariance_config.py`` and
...
from ._covariance_config import CovarianceConfig as CovarianceConfig
from ._covariance_config import CovarianceMode as CovarianceMode
from ._covariance_config import EwmaShrinkConfig as EwmaShrinkConfig
from ._covariance_config import SlidingWindowConfig as SlidingWindowConfig
