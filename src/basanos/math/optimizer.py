...
# Guard against near-zero variance in correlation computation.
# The threshold 1e-14 is chosen as ~50x machine epsilon for float64
# (numpy.finfo(float).eps ≈ 2.2e-16), providing a conservative safety margin
# that avoids spurious correlations without masking legitimately small but
# meaningful variances.  A pair whose joint variance denominator falls below
# this value is treated as undefined (NaN) rather than ±1.
_MIN_CORR_DENOM: float = 1e-14
