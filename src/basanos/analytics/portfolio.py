...
class Portfolio:
    ...
    def stats(self) -> Stats:
        ...
        Constructs a :class:`~basanos.analytics._stats.Stats` instance from
    ...
    def plots(self) -> Plots:
        ...
        Returns:
            :class:`~basanos.analytics._plots.Plots`: Helper object with
            plotting methods.
        """
        return Plots(self)
    ...
    def report(self) -> Report:
        ...
        Returns:
            :class:`~basanos.analytics._report.Report`: Helper object with
            report methods.
        """
        return Report(self)
